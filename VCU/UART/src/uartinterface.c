...
#include <string.h>
#include <unistd.h>
#include <fcntl.h>   //linux 파일입출력 library
#include <termios.h> // POSIX C termios library
#include <errno.h>

//uart 포트를 여는 함수
//device : file discpritor, rate : baudrate
int open_serial_port(const char *device, int rate) {
    ...
    // Set the new attributes to file discrptor
